...
class TicketController extends Controller
{
    ...
    public function trashed(Request $request)
    {
        ...
        return view('admin.pages.tickets.trashed', compact('items', 'search', 'limit'));
    }
    ...
    function recover($ticket)
    {
        ...
        $ticket->restore();
        return redirect()->route("admin.tickets.index")->with("success", "The item recovered permanently");
