                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-12">
                                <div class="form-group">
                                    <label>Price</label>
                                    <input class="form-control" name="price" value="{{ $payment->price }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="discount" value="{{ $payment->discount }}">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control form-select">
                                        @foreach (config('admin.user_transaction_status') as $key => $item)
                                            <option @if ($key == $payment->status) selected @endif
                                                value="{{ $key }}">{{ $item }}
                                            </option>
                                        @endforeach
                                    </select>
