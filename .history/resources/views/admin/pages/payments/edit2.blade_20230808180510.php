                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                <label>Name</label>
                                <input type="text" value="{{ $transaction->user->first_name }} {{ $transaction->user->last_name }}"
                            ...
                            <div class="col-lg-3 col-12">
                                <div class="form-group">
                                    <label>Price</label>
                                    <input class="form-control" name="price" value="{{ $transaction->price }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="discount" value="{{ $transaction->discount }}">
                                </div>
                            </div>
