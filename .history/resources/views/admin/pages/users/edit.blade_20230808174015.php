                    ...
                    <div class="card-body">
                        @if (request()->fund)
                            <div class="form-group col-lg-2">
                                ...
                                <input type="text" value="{{ old('balance', $user->wallet->balance) }}" name="balance"
                        ...
                        @else
                            <div class="row">
                                ...
                                <div class="form-group col-lg-2">
                                    <label>Wallet Balance</label>
                                    <input type="text" value="{{ old('balance', $user->wallet->balance) }}"
                                        name="balance" class="form-control @error('balance') is-invalid @enderror" required>
                                </div>
                                ...
                                <div class="form-group col-lg-1">
                                    <label>Phone</label>
                                    <input type="phone" value="{{ old('phone', $user->phone) }}" name="phone"
                                ...
                                <div class="form-group col-lg-3">
                                    <label>State</label>
                                    <input type="state" value="{{ old('state', $user->state) }}" name="state"
                                        class="form-control @error('state') is-invalid @enderror">
                                </div>

                                <div class="form-group col-lg-3">
                                    <label>City</label>
                                    <input type="city" value="{{ old('city', $user->city) }}" name="city"
                                ...
                                <div class="form-group col-lg-6">
                                    <label>Address</label>
                                    <input type="address" value="{{ old('address', $user->address) }}" name="address"
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="verified" class="form-check-input" value="1"
                                            id="exampleCheck2" @if (old('enable', $user->verified)) checked @endif>
