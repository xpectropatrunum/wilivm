                ...
                <form action="{{ route('admin.invoices.update', $invoice->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 invoice-price">
                                ${{ $invoice->price }}
                            </div>
                            ...
                            <div class="col-lg-3 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-select">
                                        <option @if ($invoice->status == 0) selected @endif value="0">Unpaid
                                        </option>
                                        <option @if ($invoice->status == 1) selected @endif value="1">Paid
                                        </option>
                                    </select>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(() => {
            ...
            <form class="row my-1">
                ...
                <div class="col-lg-3">
                    <a data-url="{{ route('admin.invoices.items.add', $invoice->id) }}">
                        <button type="button" class="btn btn-success">Submit</button>
                    </a>

                    <a data-url="{{ route('admin.invoices.items.remove', $invoice->id) }}">
