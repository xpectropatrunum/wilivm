        ...
        $(() => {
            ...
            $(".add-variable").click(function() {
                ...
                <form class="row">
                    ...
                    <div class="col-lg-4">
                        <a data-url="{{ route('admin.invoices.items.add', $product->id) }}">
                            <button type="button" class="btn btn-success">Submit</button>
                        </a>

                        <a data-url="{{ route('admin.invoices.items.remove', $product->id) }}">
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            if (res) {
                                if (res.id) {
                                    $(oldForm).html("")
                                    $(".variables-tbody").append(`<form class="row">
                                        <div class="col-lg-4">${res.brand_fa}</div>
                                        <div class="col-lg-4">${res.price}</div>
                                        <div class="col-lg-4">
                                            <a data-url="/admin/invoices/items/remove/${res.id}">
                                                <button type="button" class="btn btn-danger remove-prop-pre-form">حذف</button>
                                            </a>
                                        </div>
