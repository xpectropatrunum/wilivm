                ...
                <form action="{{ route('admin.invoices.update', $invoice->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3">
                                <label>Title</label>
                                <input name="title" class="form-control" value="{{ old('title', $invoice->title) }}">
                            </div>
                            <div class="col-lg-3 col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="order_id" disabled
                                        class="form-select select2">
                                        <option value="0">Optional</option>
                                        @foreach ($orders as $item)
                                            <option @if($invoice->order_id == $item->id) selected @endif value="{{ $item->id }}">#{{ $item->id }} {{ $item->user?->email }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <textarea name="description" class="form-control" rows="4">{{ old('description', $invoice->description) }}</textarea>
                            </div>
