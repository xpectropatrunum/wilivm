                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                Expires in: {{ MyHelper::due($order, 0, 1) }}<br>
                            ...
                            <div class="col-lg-3 col-12">
                                <div class="form-group">
                                    ...
                                    <input name="ipv4_2" class="form-control" value="{{ $order->service->ipv4_2 }}">
                                </div>
                            </div>
                            <div class="col-lg-3 col-12">
                                <div class="form-group">
...
@push('admin_js')
    ...
    <script>
        ...
        var fetched_price = 0;
        var odd = {{ round(($order->due_date - time()) / (86400 * $order->cycle * 30), 2) }};
        var order_price = {{ $order->price }};
        $("[name=upgrade]").change(function() {
            if ($(this).is(":checked")) {
                $("[name=price]").val(Math.round(fetched_price * 100 * odd) / 100 - order_price)
