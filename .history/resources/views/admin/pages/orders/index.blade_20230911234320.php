        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center px-3" style="justify-content: space-between;">
                    ...
                    <a href="{{route("admin.orders.trashed")}}"><button type="button" class="btn btn-outline-primary"> Trashed ({{App\Models\Order::onlyTrashed()->count()}})</button></a>
                </div>


                <div class="px-3 mt-2"> <a href="{{ route('admin.orders.excel', request()->all()) }}"><button type="button"
