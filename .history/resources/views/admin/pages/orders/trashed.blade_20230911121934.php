...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">trashed orders</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center px-3" style="justify-content: space-between;">
                    <h3 class="card-title">trashed orders</h3>
                                ...
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td class="project-actions">
                                            ...
                                            <form action="{{ route('admin.orders.recover', $item->id) }}"
                                            ...
                                            <form action="{{ route('admin.orders.permanent_destroy', $item->id) }}"
                                                class="d-inline-block" method="POST">
                                                @csrf
                                                @method('DELETE')
