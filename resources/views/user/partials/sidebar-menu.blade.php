<div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo" >
                <a href="/"><img src="{{ asset('assets/images/logo/wilivm-logo.png') }}" style="height: 62px;" alt="Wilivm" srcset=""></a>
            </div>
        ...
        <ul class="menu">
            ...
            @foreach ($menus as $menu)
                <li
                    ...
                    <a href="{{ route('panel.' . $menu->url) }}" class='sidebar-link'>
                        <i class="bi bi-{{ $menu->icon }}"></i>
                      

                        <span>{{ $menu->name }}</span>
                        @if ($menu->badge?? null > 0)
                        <span class="badge bg-danger">{{ $menu->badge }}</span>
                    @endif
                    </a>
                </li>
            @endforeach
    ...
    <footer>
        <div class="footer clearfix mb-0 text-muted" style="
    ...
    <p>{{date("Y")}} @ <a href="https://wilivm.com" target="_blank">Wilivm</a>
    </p>
            </div>
