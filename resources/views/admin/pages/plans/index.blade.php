        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body p-3">
                    <form class="frm-filter" action="{{ route('admin.plans.index') }}" type="post" autocomplete="off">
                        @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input type="checkbox"
                                                    data-url="{{ route('admin.plans.status', $item->id) }}"
                                        ...
                                        <td class="project-actions">
                                            <a class="btn btn-info btn-sm"
                                                href="{{ route('admin.plans.edit', $item->id) }}">
