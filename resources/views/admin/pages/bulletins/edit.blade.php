...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit message</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <form action="{{ route('admin.bulletins.update', $bulletin->id) }}" method="post">
                    @csrf
                    @method("PUT")
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                <label>message</label>
                                <textarea name="message" class="form-control editor" rows="10">{{$bulletin->message}}</textarea>
