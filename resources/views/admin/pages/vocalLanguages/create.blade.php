...
@section('title', 'create new vocal language')
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb @if(app()->getLocale() == 'fa') float-sm-left @else float-sm-right @endif">
                ...
                <li class="breadcrumb-item active">Create new vocal language</li>
            </ol>
        </div>
    </div>
@endsection
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create new vocal language</h3>
                </div>
                <form action="{{ route('admin.vocalLanguages.store') }}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="row">
