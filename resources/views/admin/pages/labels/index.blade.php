        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body p-3">
                    <form class="frm-filter" action="{{ route('admin.labels.index') }}" type="post" autocomplete="off">
                        @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input type="checkbox"
                                                    data-url="{{ route('admin.labels.status', $item->id) }}"
                                        ...
                                        <td class="project-actions">
                                            <a class="btn btn-info btn-sm"
                                                href="{{ route('admin.labels.edit', $item->id) }}">
                                                <i class="fas fa-pen"></i>
                                                {{ __('Edit') }}
                                            </a>
                                            <form action="{{ route('admin.labels.destroy', $item->id) }}"
