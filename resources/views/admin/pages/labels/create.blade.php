...
@section('title', 'create new label')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Create new label</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb @if(app()->getLocale() == 'fa') float-sm-left @else float-sm-right @endif">
                <li class="breadcrumb-item"><a href="{{ route('admin.labels.index') }}">List labels</a></li>
                <li class="breadcrumb-item active">Create new label</li>
            </ol>
        </div>
    </div>
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" name="enable" class="form-check-input" value="1" id="exampleCheck" @if(old('enable')) checked @endif>
