...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">trashed tickets</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb @if (app()->getLocale() == 'fa') float-sm-left @else float-sm-right @endif">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('admin.dashboard') }}</a>
                </li>
                <li class="breadcrumb-item active">trashed tickets</li>
            </ol>
        </div>
    </div>
@endsection
                                ...
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td class="project-actions">
                                            ...
                                            <form action="{{ route('admin.tickets.recover', $item->id) }}"
                                            ...
                                            <form action="{{ route('admin.tickets.permanent_destroy', $item->id) }}"
                                                class="d-inline-block" method="POST">
                                                @csrf
                                                @method('DELETE')
