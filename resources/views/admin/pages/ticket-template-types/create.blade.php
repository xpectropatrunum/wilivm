...
@section('title', 'create new ticket template type')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Create new ticket template type</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb @if(app()->getLocale() == 'fa') float-sm-left @else float-sm-right @endif">
                <li class="breadcrumb-item"><a href="{{ route('admin.ticket-template-types.index') }}">List ticket template types</a></li>
                <li class="breadcrumb-item active">Create new ticket template type</li>
            </ol>
        </div>
    </div>
@endsection
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create new ticket template type</h3>
                </div>
                <form action="{{ route('admin.ticket-template-types.store') }}" method="post">
                    @csrf
