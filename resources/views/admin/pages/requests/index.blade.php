        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center px-3 justify-content-between">
                    ...
                    <a class="btn btn-info btn-sm text-right" href="{{ route('admin.requests.create') }}">
                        <i class="fas fa-plus"></i>
                        {{ __('New Request') }}
                    </a>
                </div>
                <div class="card-body p-3">
                    <form class="frm-filter" action="{{ route('admin.requests.index') }}" type="post" autocomplete="off">
                        @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-actions">
                                            <a class="btn btn-info btn-sm"
                                                href="{{ route('admin.requests.edit', $item->id) }}">
                                                <i class="fas fa-pen"></i>
                                                {{ __('Edit') }}
                                            </a>
                                            <form action="{{ route('admin.requests.destroy', $item->id) }}"
