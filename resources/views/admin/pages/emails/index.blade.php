        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body p-3">
                    <form class="frm-filter" action="{{ route('admin.emails.index') }}" type="post" autocomplete="off">
                        @csrf
                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->title }}</td>
                                        <td>{{ App\Enums\EEmailType::getKey($item->type) }}</td>
                                        <td>
                                            <div class="form-check">
                                                <input type="checkbox"
                                                    data-url="{{ route('admin.emails.status', $item->id) }}"
                                        ...
                                        <td class="project-actions">
                                            <a class="btn btn-info btn-sm"
                                                href="{{ route('admin.emails.edit', $item->id) }}">
                                                <i class="fas fa-pen"></i>
                                                {{ __('Edit') }}
                                            </a>
                                            <form action="{{ route('admin.emails.destroy', $item->id) }}"
