        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center px-3">
                    ...
                    <a class="btn btn-outline-primary btn-sm mx-3" href="{{ route('admin.locations.clinics.create') }}"><i
                            class="fa fa-plus"></i> {{ __('admin.add_new') }}</a>

                </div>
                <div class="card-body p-3">
                    <form class="frm-filter" action="{{ route('admin.locations.clinics.index') }}" type="post" autocomplete="off">
                        @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox"
                                                    data-url="{{ route('admin.locations.clinics.status', $item->id) }}"
                                        ...
                                        <td class="project-actions">
                                            <a class="btn btn-info btn-sm"
                                                href="{{ route('admin.locations.clinics.edit', $item->id) }}">
                                                <i class="fas fa-edit"></i>
                                                {{ __('Edit') }}
                                            </a>

                                            <form action="{{ route('admin.locations.clinics.destroy', $item->id) }}"
