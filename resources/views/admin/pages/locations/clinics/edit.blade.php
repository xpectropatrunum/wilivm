            ...
            <div class="card card-primary card-outline card-outline-tabs">
                ...
                <div class="tab-content card-body" id="custom-tabs-four-tabContent">
                    ...
                    <div class="tab-pane fade" id="custom-gallery" role="tabpanel"
                        aria-labelledby="custom-tabs-basic-tab">
                        <button type="button" class="btn btn-outline-info btn-add-new-image mb-4"><svg
                                        ...
                                        <div class="form-row align-items-center">
                                            <div class="col-lg-4">
                                                <div class="form-group mb-0 d-flex align-items-center">
                                                        ...
                                                        <img class="img-fluid img-rounded pic-preview bg-light object-fit-cover mr-2"
                                                            width="60" height="60" src="{{ asset($file->image) }}">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label"
                                                            for="customFileTexture{{ $file->id }}">{{ array_reverse(explode("/", $file->image))[0]  }}
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group mb-0 d-flex align-items-center">
                                                    ...
                                                    <video width="60" height="60" class="video-preview video-preview img-fluid img-rounded pic-preview bg-light object-fit-cover mr-2" src="{{ asset($file->video) }}">
                                                        <source >
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" name="video" onchange="readURL(this)" class="custom-file-input">
                                                        <label class="custom-file-label"
                                                        for="customFileTexture{{ $file->id }}">{{ array_reverse(explode("/", $file->video))[0] }}
                                                    </label>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group mb-0 d-flex align-items-center">
                                                    <input name="title" value="{{$file->title}}" class="form-control ">
                                ...
                                <div class="form-row align-items-center">
                                    <div class="col-lg-4">
                                        <div class="form-group mb-0 d-flex align-items-center">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="image" onchange="readURL(this)"
                                                    class="custom-file-input" id="customFilegallery">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-0 d-flex align-items-center">
                                            ...
                                            <video width="60" height="60" class="video-preview img-fluid img-rounded pic-preview bg-light object-fit-cover mr-2">
                                                <source >
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="video" onchange="readURL2(this)" class="custom-file-input">
                                                <label  class="custom-file-label" for="customFilegallery">Choose
                                                    file</label>
                                            </div>
                                        </div>
...
@push('admin_js')
    ...
    <script>
        ...
        $(document).on("click", ".btn-remove-file", function() {
            id = $(this).closest('form').find('input[name="id"]').val();
            console.log($(this).closest('form').find('input[name="id"]'))
            elem = $(this);

            if (id.length) {
                $.ajax({
                    url: "{{ route('admin.locations.clinics.remove_image_gallery', $clinic->id) }}",
                    type: 'post',
                    data: {
                        'id': id,
                        "_token": "{{ csrf_token() }}",
        ...
        $('body').on('submit', '.frmSaveFile', function(e) {
            e.preventDefault();
            form = $(this);
            $button = $(this).find('.btn-save-file');
            data = new FormData($(this)[0]);
            data.append("_token", "{{ csrf_token() }}");
            $.ajax({
                url: "{{ route('admin.locations.clinics.save_image_gallery', $clinic->id) }}",
                type: 'post',
                data: data,
                dataType: 'json',
                cache: false,
