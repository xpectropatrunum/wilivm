        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body p-3">
                    <form class="frm-filter" action="{{ route('admin.locations.index') }}" type="post" autocomplete="off">
                        @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input type="checkbox"
                                                    data-url="{{ route('admin.locations.status', $item->id) }}"
                                        ...
                                        <td class="project-actions">
                                            ...
                                            {{--  <form action="{{ route('admin.locations.destroy', $item->id) }}"
