    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('admin.blocked_users.update',$blockedUser->id) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <select name="user_id" class="form-control" id="search-user" required>
                                    <option value="{{ $blockedUser->user_id }}">{{ $blockedUser->user->first_name }} {{ $blockedUser->user->last_name }}</option>
                                </select>
                            </div>
                            <div class="w-100"></div>
                            <div class="form-group col-lg-4">
                                <label>From date time:</label>
                                <input type="text" name="from_datetime" id="from-datetime" class="form-control @error('from_datetime') is-invalid @enderror" value="{{ old('from_datetime',$blockedUser->from_datetime) }}" required>
                            </div>

                            <div class="form-group col-lg-4">
                                <label>To date time:</label>
                                <input type="text" name="to_datetime" id="to-datetime" class="form-control @error('to_datetime') is-invalid @enderror" value="{{ old('to_datetime',$blockedUser->to_datetime) }}" required>
                            </div>
                            <div class="w-100"></div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" name="enable" class="form-check-input" value="1" id="exampleCheck1" {{ old('enable',$blockedUser->enable) ? 'checked' : '' }}>
