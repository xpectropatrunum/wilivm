...
@section('title', 'edit off code')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">edit off code</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb @if (app()->getLocale() == 'fa') float-sm-left @else float-sm-right @endif">
                <li class="breadcrumb-item"><a href="{{ route('admin.off-codes.index') }}">all off codes</a></li>
                <li class="breadcrumb-item active">edit off code</li>
            </ol>
        </div>
    </div>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">edit off code</h3>
                </div>
                <form action="{{ route('admin.off-codes.update', $offCode->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <select name="user_id" class="form-control select2" required>
                                    ...
                                    @foreach (App\Models\User::all() as $item)
                                        <option @if ($item->id == $offCode->user_id) selected @endif
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <select name="type" class="form-control" required>
                                    @foreach (App\Enums\EOffType::asSelectArray() as $key => $item)
                                        <option @if ($key == $offCode->type) selected @endif
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" name="amount"
                                    ...
                                    value="{{ old('amount', $offCode->amount) }}" required>
                            </div>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" name="limit"
                                    ...
                                    value="{{ old('limit', $offCode->limit) }}" required>
                            </div>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" name="code"
                                    ...
                                    value="{{ old('code', $offCode->code) }}" required>
                            </div>
                            <div class="form-group col-lg-3">
                                <label>From date time:</label>
                                <input type="text" name="from_date" id="from-datetime"
                                    class="form-control @error('from_date') is-invalid @enderror"
                                    value="{{ old('from_date', $offCode->from_date) }}" required>
                            </div>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" name="to_date" id="to-datetime"
                                    ...
                                    value="{{ old('to_date', $offCode->to_date) }}" required>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" name="enable" class="form-check-input" value="1"
                                        id="exampleCheck1" {{ old('enable', $offCode->enable) ? 'checked' : '' }}>
