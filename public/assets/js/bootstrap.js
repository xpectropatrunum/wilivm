            ...
            980: (t, e, i) => {
                    ...
                    fn: function(t) {
                        ...
                        Object.keys(e.elements).forEach((function(t) {
                            var i = e.styles[t] || {},
                                n = e.attributes[t] || {},
                                s = e.elements[t];
                            D(s) && x(s) && (Object.assign(s.style, i),
                        ...
                        return Object.assign(e.elements.popper.style, i.popper),
                            ...
                            function() {
                                Object.keys(e.elements).forEach((function(t) {
                                    ...
                                    D(n) && x(n) && (Object.assign(n.style, o),
                ...
                function W(t, e, i) {
                    ...
                    var n = t.getBoundingClientRect(),
                        s = 1,
                        o = 1;
                    e && D(t) && (s = t.offsetWidth > 0 && M(n.width) / t.offsetWidth || 1,
                ...
                function Q(t) {
                    for (var e = k(t), i = K(t); i && q(i) && "static" === z(i).position;)
                        i = K(i);
                    return i && ("html" === x(i) || "body" === x(i) && "static" === z(i).position) ? e : i || function(t) {
                        var e = /firefox/i.test(H());
                        if (/Trident/i.test(H()) && D(t) && "fixed" === z(t).position)
                            return null;
                        var i = V(t);
                ...
                function et(t) {
                    ...
                    if (p) {
                        var x = Q(i),
                            L = "clientHeight",
                            D = "clientWidth";
                        if (x === k(i) && "static" !== z(x = R(i)).position && "absolute" === u && (L = "scrollHeight",
                                D = "scrollWidth"),
                            l === n || (l === r || l === o) && c === h)
                            C = s,
                            y -= (m && x === O && O.visualViewport ? O.visualViewport.height : x[L]) - a.height,
                            y *= f ? 1 : -1;
                        if (l === r || (l === n || l === s) && c === h)
                            T = o,
                            b -= (m && x === O && O.visualViewport ? O.visualViewport.width : x[D]) - a.width,
                            b *= f ? 1 : -1
                    }
                    ...
                    return b = P.x,
                        y = P.y,
                        f ? Object.assign({}, I, ((S = {})[C] = E ? "0" : "",
                            S[T] = A ? "0" : "",
                            S.transform = (O.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + y + "px)" : "translate3d(" + b + "px, " + y + "px, 0)",
                            S)) : Object.assign({}, I, ((e = {})[C] = E ? y + "px" : "",
                            e[T] = A ? b + "px" : "",
                            e.transform = "",
                            e))
                }
                ...
                const vt = {
                    ...
                    fn: function(t) {
                        ...
                        if (!e.modifiersData[h]._skip) {
                            ...
                            e.placement !== N && (e.modifiersData[h]._skip = !0,
                                e.placement = N,
                                e.reset = !0)
                        }
                    },
            ...
            666: function(t, e, i) {
                t.exports = function(t) {
                    ...
                    class Z extends R {
                        ...
                        _initEvents() {
                            this._supportPointerEvents ? (H.on(this._element, "pointerdown.bs.swipe", (t => this._start(t))),
                                H.on(this._element, "pointerup.bs.swipe", (t => this._end(t))),
                                this._element.classList.add("pointer-event")) : (H.on(this._element, "touchstart.bs.swipe", (t => this._start(t))),
                                H.on(this._element, "touchmove.bs.swipe", (t => this._move(t))),
                                H.on(this._element, "touchend.bs.swipe", (t => this._end(t))))
                        }
                    ...
                    class ht extends V {
                        ...
                        to(t) {
                            ...
                            if (t > e.length - 1 || t < 0)
                                return;
                            if (this._isSliding)
                                return void H.one(this._element, st, (() => this.to(t)));
                        ...
                        _addEventListeners() {
                            this._config.keyboard && H.on(this._element, "keydown.bs.carousel", (t => this._keydown(t))),
                                "hover" === this._config.pause && (H.on(this._element, "mouseenter.bs.carousel", (() => this.pause())),
                                    H.on(this._element, "mouseleave.bs.carousel", (() => this._maybeEnableCycle()))),
                    ...
                    H.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", (function(t) {
                            ...
                            return n ? (i.to(n),
                                void i._maybeEnableCycle()) : "next" === q.getDataAttribute(this, "slide") ? (i.next(),
                    ...
                    class jt extends V {
                        constructor(t, e) {
                            super(t, e),
                                ...
                                this._menu = U.next(this._element, Ot)[0] || U.prev(this._element, Ot)[0] || U.findOne(Ot, this._parent),
                    ...
                    H.on(document, At, Tt, jt.dataApiKeydownHandler),
                        ...
                        H.on(document, "keyup.bs.dropdown.data-api", jt.clearMenus),
                    ...
                    class Bt {
                        ...
                        hide() {
                            ...
                            this._disableOverFlow(),
                                ...
                                this._setElementAttributes(Ht, Wt, (e => e - t))
                        }
                        reset() {
                        ...
                        _resetElementAttributes(t, e) {
                            this._applyManipulationCallback(t, (t => {
                                ...
                                null !== i ? (q.removeDataAttribute(t, e),
                    ...
                    class Vt extends R {
                        ...
                        dispose() {
                            this._isAppended && (H.off(this._element, zt),
                                this._element.remove(),
                                this._isAppended = !1)
                        }
                        _getElement() {
                            ...
                            this._isShown && (H.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (this._focustrap.deactivate(),
                                ...
                                this._queueCallback((() => {
                                    this._element.classList.remove(oe, ae),
                                        this._element.removeAttribute("aria-modal"),
                                        this._element.removeAttribute("role"),
                                        this._config.scroll || (new Bt).reset(),
                    ...
                    H.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', (function(t) {
                        ...
                        H.on(window, "resize.bs.offcanvas", (() => {
                            for (const t of U.find("[aria-modal][class*=show][class*=offcanvas-]"))
                                "fixed" !== getComputedStyle(t).position && fe.getOrCreateInstance(t).hide()
                        })),
                        K(fe),
                        b(fe);
                            ...
                            return this._config.sanitize ? function(t, e, i) {
                                ...
                                for (const t of s) {
                                    ...
                                    const n = [].concat(...t.attributes),
                                        s = [].concat(e["*"] || [], e[i] || []);
                                    for (const e of n)
                                        _e(e, s) || t.removeAttribute(e.nodeName)
                                }
                    ...
                    class Pe extends V {
                        ...
                        dispose() {
                            clearTimeout(this._timeout),
                                H.off(this._element.closest(Oe), xe, this._hideModalHandler),
                        ...
                        show() {
                            ...
                            if (this._element.ownerDocument.documentElement.contains(this.tip) || (n.append(i),
                                ...
                                for (const t of[].concat(...document.body.children))
                                    H.on(t, "mouseover", f);
                            this._queueCallback((() => {
                                H.trigger(this._element, this.constructor.eventName("shown")), !1 === this._isHovered && this._leave(),
                                    this._isHovered = !1
                        ...
                        _setListeners() {
                            ...
                            for (const e of t)
                                ...
                                H.on(this._element, t, this._config.selector, (t => {
                                        ...
                                        e._activeTrigger["focusin" === t.type ? Le : ke] = !0,
                                            e._enter()
                                    })),
                                    H.on(this._element, i, this._config.selector, (t => {
                                        const e = this._initializeOnDelegatedTarget(t);
                                        e._activeTrigger["focusout" === t.type ? Le : ke] = e._element.contains(t.relatedTarget),
                                            e._leave()
                                    }))
                            }
                    ...
                    class ze extends V {
                        ...
                        _maybeEnableSmoothScroll() {
                            this._config.smoothScroll && (H.off(this._config.target, He),
                        ...
                        _process(t) {
                            this._activeTarget !== t && (this._clearActiveClass(this._config.target),
                                ...
                                H.trigger(this._element, "activate.bs.scrollspy", {
                                    relatedTarget: t
                                }))
                        }
                        _activateParents(t) {
                            if (t.classList.contains("dropdown-item"))
                                U.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add($e);
                            else
                        ...
                        constructor(t) {
                            super(t),
                                ...
                                this._parent && (this._setInitialAttributes(this._parent, this._getChildren()),
                                    H.on(this._element, "keydown.bs.tab", (t => this._keydown(t))))
                        }
                        static get NAME() {
                            return "tab"
                        }
                    ...
                    class si extends V {
                        ...
                        hide() {
                            this.isShown() && (H.trigger(this._element, "hide.bs.toast").defaultPrevented || (this._element.classList.add(ei),
                                this._queueCallback((() => {
