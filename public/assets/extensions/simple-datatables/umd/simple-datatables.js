    ...
    return (function() {
        ...
        2: [function(require, module, exports) {
            ...
            class n {
                ...
                setCursor(t = !1) {
                    this.cursor && this.cursor.classList.remove("dataTable-cursor"),
                        t && (t.classList.add("dataTable-cursor"),
                            this.cursor = t)
                }
                render(t) {
                    return t
            ...
            class r {
                            ...
                            i = e.cloneNode(!1),
                                ...
                                t.forEach((t => {
                                    o = e.cells[t].cloneNode(!0),
                                        ...
                                        i.appendChild(o),
                                        l.hiddenColumns.includes(t) || (o = e.cells[t].cloneNode(!0),
                                            o.data = e.cells[t].data,
                                            a.appendChild(o))
                                })),
                                h[2].push(i),
                ...
                sort(t, e, s) {
                    const i = this.dt;
                    if (i.hasHeadings && (t < 0 || t > i.headings.length))
                        return !1;
                    ...
                    if ("date" === c.getAttribute("data-type")) {
                        ...
                        c.hasAttribute("data-format") && (t = c.getAttribute("data-format")),
                            p.push(Promise.resolve().then((function() {
                                return require("./date-7061ceee.js.js.js")
                    ...
                    Promise.all(p).then((n => {
                        ...
                        Array.from(r).forEach((e => {
                                const s = e.cells[t],
                                    i = s.hasAttribute("data-content") ? s.getAttribute("data-content") : s.innerText;
                                let a;
                                a = p ? p(i) : "string" == typeof i ? i.replace(/(\$|,|\s|%)/g, "") : i,
                                    parseFloat(a) == a ? h[d++] = {
                                        value: Number(a),
                                        row: e
                                    } : o[l++] = {
                            ...
                            "desc" == e ? (u = a(o, -1),
                                ...
                                c.setAttribute("aria-sort", "descending")) : (u = a(h, 1),
                                g = a(o, 1),
                                c.classList.remove("desc"),
                                c.classList.add("asc"),
                                c.setAttribute("aria-sort", "ascending")),
                            i.lastTh && c != i.lastTh && (i.lastTh.classList.remove("desc"),
            ...
            const o = function(t) {
                    ...
                    t.data && t.data.length && (i = e("tbody"),
                            t.data.forEach((s => {
                        ...
                        s && (null !== this.dom.tHead && this.dom.removeChild(this.dom.tHead),
                            this.dom.appendChild(s)),
                        i && (this.dom.tBodies.length && this.dom.removeChild(this.dom.tBodies[0]),
            ...
            exports.DataTable = class {
                constructor(t, e = {}) {
                    ...
                    if (this.options = {
                        ...
                        this.options.tabIndex ? s.tabIndex = this.options.tabIndex : this.options.rowNavigation && -1 === s.tabIndex && (s.tabIndex = 0),
                ...
                render() {
                    let t = "";
                    if (this.options.data && o.call(this),
                        this.body = this.dom.tBodies[0],
                        this.head = this.dom.tHead,
                        this.foot = this.dom.tFoot,
                        this.body || (this.body = e("tbody"),
                            this.dom.appendChild(this.body)),
                        this.hasRows = this.body.rows.length > 0, !this.head) {
                        const t = e("thead"),
                            s = e("tr");
                    ...
                    if (this.headings = [],
                        ...
                        this.options.header || this.head && this.dom.removeChild(this.dom.tHead),
                        this.options.footer ? this.head && !this.foot && (this.foot = e("tfoot", {
                        ...
                        t += "</div>",
                        this.options.scrollY.length ? t += `<div class='dataTable-container' style='height: ${this.options.scrollY}; overflow-Y: auto;'></div>` : t += "<div class='dataTable-container'></div>",
                        t += "<div class='dataTable-bottom'>",
                        t += this.options.layout.bottom,
                        t += "</div>",
                        t = t.replace("{info}", this.options.paging ? "<div class='dataTable-info'></div>" : ""),
                ...
                renderPage(t = !1) {
                    if (this.hasHeadings && (s(this.header),
                    ...
                    let e, i = 0,
                        a = 0,
                        n = 0;
                    if (this.totalPages && (i = this.currentPage - 1,
                    ...
                    if (1 == this.currentPage && this.fixHeight(),
                        this.options.rowNavigation && (!this.rows.cursor || !this.pages[this.currentPage - 1].includes(this.rows.cursor))) {
                ...
                renderPager() {
                    if (s(this.pagers),
                        ...
                        this.options.firstLast && s.appendChild(i(t, 1, this.options.firstText)),
                            this.options.nextPrev && !this.onFirstPage && s.appendChild(i(t, a, this.options.prevText));
                        let r = this.links;
                        this.options.truncatePager && (r = ((t, s, i, a, n) => {
                            ...
                            this.links[this.currentPage - 1].classList.add("active"),
                            this.options.nextPrev && !this.onLastPage && s.appendChild(i(t, n, this.options.nextText)),
                            this.options.firstLast && s.appendChild(i(t, this.totalPages, this.options.lastText)),
                ...
                renderHeader() {
                    this.labels = [],
                        this.headings && this.headings.length && this.headings.forEach(((t, s) => {
                            if (this.labels[s] = t.textContent,
                ...
                bindEvents() {
                    ...
                    this.options.searchable && (this.input = this.wrapper.querySelector(".dataTable-input"),
                            this.input && this.input.addEventListener("keyup", (() => this.search(this.input.value)), !1)),
                        this.wrapper.addEventListener("click", (t => {
                            const e = t.target.closest("a");
                            e && "a" === e.nodeName.toLowerCase() && (e.hasAttribute("data-page") ? (this.page(e.getAttribute("data-page")),
                                t.preventDefault()) : this.options.sortable && e.classList.contains("dataTable-sorter") && "false" != e.parentNode.getAttribute("data-sortable") && (this.columns.sort(this.headings.indexOf(e.parentNode)),
                                t.preventDefault()))
                        }), !1),
                        this.options.rowNavigation ? (this.table.addEventListener("keydown", (t => {
                                38 === t.keyCode ? this.rows.cursor.previousElementSibling ? (this.rows.setCursor(this.rows.cursor.previousElementSibling),
                                    t.preventDefault(),
                                    t.stopPropagation()) : this.onFirstPage || this.page(this.currentPage - 1, !0) : 40 === t.keyCode ? this.rows.cursor.nextElementSibling ? (this.rows.setCursor(this.rows.cursor.nextElementSibling),
                                    t.preventDefault(),
                                    t.stopPropagation()) : this.onLastPage || this.page(this.currentPage + 1) : [13, 32].includes(t.keyCode) && this.emit("datatable.selectrow", this.rows.cursor, t)
                            })),
                        ...
                        this.options.columns && this.headings.length && this.options.columns.forEach((t => {
                            Array.isArray(t.select) || (t.select = [t.select]),
                                ...
                                t.select.forEach((e => {
                                    ...
                                    s && (t.type && s.setAttribute("data-type", t.type),
                                        t.format && s.setAttribute("data-format", t.format),
                ...
                paginate() {
                    ...
                    return this.searching && (t = [],
                        ...
                        this.options.paging ? this.pages = t.map(((e, s) => s % this.options.perPage == 0 ? t.slice(s, s + this.options.perPage) : null)).filter((t => t)) : this.pages = [t],
                ...
                fixColumns() {
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        if (this.columnWidths = [],
                            this.dom.tHead) {
                            this.options.scrollY.length && (s = e("thead"),
                                    s.appendChild(e("tr")),
                                    s.style.height = "0px",
                ...
                search(t) {
                    return !!this.hasRows && (t = t.toLowerCase(),
                        ...
                        t.length ? (this.clear(),
                                ...
                                t.split(" ").reduce(((t, s) => {
                                    ...
                                    for (let t = 0; t < e.cells.length; t++)
                                        if (a = e.cells[t],
                                            ...
                                            n.toLowerCase().includes(s) && this.columns.visible(a.cellIndex)) {
                                            i = !0;
                                            break
                                        }
                                    return t && i
                            ...
                            this.wrapper.classList.remove("search-results"), !1))
                }
                page(t, e = !1) {
                    return t != this.currentPage && (isNaN(t) || (this.currentPage = parseInt(t, 10)), !(t > this.pages.length || t < 0) && (this.renderPage(e),
                        this.renderPager(),
                ...
                export (e) {
                    ...
                    if (l.type) {
                        if ("txt" !== l.type && "csv" !== l.type || (i[0] = this.header),
                            l.selection)
                            if (isNaN(l.selection)) {
                                ...
                                i = i.concat(this.pages[l.selection - 1]);
                        else
                        ...
                        if (i.length) {
                            if ("txt" === l.type || "csv" === l.type) {
                                ...
                                for (o = `INSERT INTO \`${l.tableName}\` (`,
                                    n = 0; n < s.length; n++)
                                    !l.skipColumn.includes(s[n].originalCellIndex) && this.columns.visible(s[n].originalCellIndex) && (o += `\`${s[n].textContent}\`,`);
                                for (o = o.trim().substring(0, o.length - 1),
                                    o += ") VALUES ",
                                    n = 0; n < i.length; n++) {
                                    for (o += "(",
                                        r = 0; r < i[n].cells.length; r++)
                                        !l.skipColumn.includes(s[r].originalCellIndex) && this.columns.visible(s[r].originalCellIndex) && (o += `"${i[n].cells[r].textContent}",`);
                                    o = o.trim().substring(0, o.length - 1),
                                        o += "),"
                                }
                                o = o.trim().substring(0, o.length - 1),
                                ...
                                for (r = 0; r < i.length; r++)
                                    for (a[r] = a[r] || {},
                                        n = 0; n < s.length; n++)
                                        !l.skipColumn.includes(s[n].originalCellIndex) && this.columns.visible(s[n].originalCellIndex) && (a[r][s[n].textContent] = i[r].cells[n].textContent);
                ...
                import (e) {
                    ...
                    if (i.data.length || t(i.data)) {
                        if ("csv" === i.type) {
                            ...
                            t.length && (i.headings && (s.headings = t[0].split(i.columnDelimiter),
